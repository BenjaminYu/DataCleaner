...
public class FixedWidthDatastore extends UsageAwareDatastore<DataContext> implements FileDatastore, ResourceDatastore {
    ...
    public FixedWidthDatastore(String name, String filename, String encoding, int fixedValueWidth,
        ...
        this(name, null, filename, encoding, fixedValueWidth, failOnInconsistencies, FixedWidthConfiguration.DEFAULT_COLUMN_NAME_LINE);
    }

    public FixedWidthDatastore(String name, String filename, String encoding, int[] valueWidths,
            boolean failOnInconsistencies) {
        this(name, null, filename, encoding, valueWidths, failOnInconsistencies,
                FixedWidthConfiguration.DEFAULT_COLUMN_NAME_LINE);
    }

    public FixedWidthDatastore(String name, Resource resource, String filename, String encoding, int fixedValueWidth, boolean failOnInconsistencies, int headerLineNumber) {
        super(name);
        _filename = filename; 
        if (resource == null) {
