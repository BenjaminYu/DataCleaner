...
public class DomConfigurationWriterTest {
    ...
    public void testWriteAndReadFixedWidthDatastore() throws Exception {
        final FileResource fileResource = new FileResource("C://test.csv");
        final FixedWidthDatastore fixedWidthDatastore = new FixedWidthDatastore("my fixed width ds", fileResource, fileResource.getName(),"UTF-8", 20, false, 1); 
        ...
        final FixedWidthDatastore fixedWidthDatastore2 = new FixedWidthDatastore("my fixed width ds 2", fileResource, fileResource.getName(),"UTF-8", new int[] {19, 22}, false, 1); 
